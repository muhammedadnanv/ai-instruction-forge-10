...
const PromptCollection = ({ setInstruction, setSelectedFramework }: PromptCollectionProps) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-800">Gemini-Powered Templates</h2>
